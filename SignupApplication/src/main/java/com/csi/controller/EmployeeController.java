...
public class EmployeeController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Employee employee = new Employee(empId, empName, empAddress, empSalary, empEmailId, empContactNumber);

		employeeServiceImpl.signup(employee);

		RequestDispatcher requestDispatcher = request.getRequestDispatcher("showData.jsp");
